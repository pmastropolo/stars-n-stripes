...
const PriPolicy = () => {
    ...
    <p className="mb-4">This Privacy Policy ("Policy") applies to https://starsnstripesautomotive.com, and Stars & Stripes Automotive, LLC ("Company") and governs data collection and usage. For the purposes of this Privacy Policy, unless otherwise noted, all references to the Company include https://starsnstripesautomotive.com. The Company's website is a comprehensive resource for Stars & Stripes Automotive, an auto repair shop located in Bessemer, Alabama, specializing in LS/EFI conversions, mechanical and electrical repairs, paint jobs, and bodywork. By using the Company website, you consent to the data practices described in this statement.</p>

    <h3 className="text-xl font-bold mb-2">Collection of your Personal Information</h3>
    <p className="mb-4">In order to better provide you with products and services offered, the Company may collect personally identifiable information, such as your:</p>
    <ul className="list-disc pl-6 mb-4">
        <li>First and last name</li>
        <li>Mailing address</li>
        <li>Email address</li>
        <li>Phone number</li>
        <li>Project details and requirements: Specifics about the type of auto repair or services needed.</li>
    </ul>
    <p className="mb-4">If you purchase the Company's products and services, we collect billing and credit card information. This information is used to complete the purchase transaction.</p>

    <p className="mb-4">Please keep in mind that if you directly disclose personally identifiable information or personally sensitive data through the Company's public message boards, this information may be collected and used by others.</p>
    ...
    <h3 className="text-xl font-bold mb-2">Use of your Personal Information</h3>
    <p className="mb-4">The Company collects and uses your personal information in the following ways:</p>
    <ul className="list-disc pl-6 mb-4">
        ...
        <li>To notify you about changes to our https://starsnstripesautomotive.com</li>
        <li>In any other way we may describe when you provide the information</li>
        <li>For any other purpose with your consent</li>
    </ul>

    <p className="mb-4">The company may also use your personally identifiable information to inform you of other products or services available from the company and its affiliates.</p>

    <h3 className="text-xl font-bold mb-2">Sharing Information with Third Parties</h3>
    <p className="mb-4">The Company does not sell, rent, or lease its customer lists to third parties.</p>
    ...
    <h3 className="text-xl font-bold mb-2">Opt-Out of Disclosure of Personal Information to Third Parties</h3>
    <p className="mb-4">In connection with any personal information we may disclose to a third party for a business purpose, you have the right to know:</p>
    <ul className="list-disc pl-6 mb-4">
        <li>The categories of personal information that we disclosed about you for a business purpose.</li>
    </ul>

    <p className="mb-4">You have the right under the California Consumer Privacy Act of 2018 (CCPA) and certain other privacy and data protection laws, as applicable, to opt out of the disclosure of your personal information. If you exercise your right to opt out of the disclosure of your personal information, we will refrain from disclosing your personal information, unless you subsequently provide express authorization for the disclosure of your personal information. To opt out of the disclosure of your personal information, visit this web page https://starsnstripesautomotive.com/contact.</p>

    <h3 className="text-xl font-bold mb-2">Tracking User Behavior</h3>
    ...
    <h3 className="text-xl font-bold mb-2">Use of Cookies</h3>
    ...
    <h3 className="text-xl font-bold mb-2">Security of your Personal Information</h3>
    <p className="mb-4">The Company secures your personal information from unauthorized access, use, or disclosure. The Company uses the following methods for this purpose:</p>
    <ul className="list-disc pl-6 mb-4">
        <li>SSL Protocol</li>
        <li>Secure Payment Processing</li>
    </ul>

    <p className="mb-4">When personal information (such as a credit card number) is transmitted to other websites, it is protected through the use of encryption, such as the Secure Sockets Layer (SSL) protocol.</p>

    <p className="mb-4">We strive to take appropriate security measures to protect against unauthorized access to or alteration of your personal information. Unfortunately, no data transmission over the Internet or any wireless network can be guaranteed to be 100% secure. As a result, while we strive to protect your personal information, you acknowledge that: (a) there are security and privacy limitations inherent to the Internet that are beyond our control; and (b) the security, integrity, and privacy of any and all information and data exchanged between you and us through this site cannot be guaranteed.</p>

    <h3 className="text-xl font-bold mb-2">Right to Deletion</h3>
    <p className="mb-4">Subject to certain exceptions set out below, on receipt of a verifiable request from you, we will:</p>
    <ul className="list-disc pl-6 mb-4">
        <li>Delete your personal information from our records; and</li>
        <li>Direct any service providers to delete your personal information from their records.</li>
    </ul>

    <p className="mb-4">Please note that we may not be able to comply with requests to delete your personal information if it is necessary to:</p>
    <ul className="list-disc pl-6 mb-4">
    ...
    <p className="mb-4">This Privacy Policy is effective as of February 3, 2025.</p>
